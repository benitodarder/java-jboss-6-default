...
import local.tin.tests.dao.interfaces.IAbstractDAO;
 ...
 * @param <C1>
 */
public abstract class AbstractDAO<C0 extends local.tin.tests.model.domain.interfaces.IIdentifiable, C1 extends local.tin.tests.model.data.interfaces.IIdentifiable>  implements IAbstractDAO<C0> {
